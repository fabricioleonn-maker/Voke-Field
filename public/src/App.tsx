...
function VokeLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M25 25 L45 75 C 47 81, 53 81, 55 75 L75 25" stroke="currentColor" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M45 45 L75 25 L90 25 L60 75" stroke="#4A6FA5" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row font-sans text-voke-dark bg-white">
      ...
      <div className="hidden lg:flex lg:w-[55%] bg-gradient-to-br from-[#323c4a] to-[#1a202c] relative overflow-hidden flex-col items-center justify-center p-6 lg:p-12 min-h-[60vh] lg:min-h-screen">
        ...
        <div className="z-20 text-center max-w-xl w-full mt-8 lg:mt-0">
          <div className="flex items-center justify-center gap-3 mb-8 text-white">
            <VokeLogo className="w-10 h-10 text-white" />
            <span className="text-3xl font-bold tracking-tight">Voke Field</span>
          </div>
          <h1 className="text-3xl lg:text-[2.5rem] font-bold text-white mb-4 leading-tight">
        ...
        <div className="w-full z-10 mt-4 mb-12 lg:mb-0">
          <DashboardMockup />
        </div>
      </div>
      ...
      <div className="w-full lg:w-[45%] bg-white flex flex-col justify-center p-8 lg:p-16 min-h-screen lg:min-h-0 relative z-30">
        <div className="max-w-[400px] w-full mx-auto">
          {/* Mobile Logo */}
          <div className="flex items-center justify-center gap-3 mb-12 lg:hidden text-voke-dark">
            <VokeLogo className="w-10 h-10 text-voke-dark" />
            <span className="text-3xl font-bold tracking-tight">Voke Field</span>
          </div>
